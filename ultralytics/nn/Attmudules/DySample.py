...
def constant_init(module, val, bias=0):
    """Initialize conv weights with a constant value."""
    if hasattr(module, 'weight') and module.weight is not None:
...
class DySample(nn.Module):
    """Learning to Upsample by Learning to Sample (official lightweight implementation style)."""
